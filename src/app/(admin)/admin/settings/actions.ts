...
export async function saveAiPrompts(
  ...
  const fields = [
    ...
    { key: SETTING_KEYS.consolidation_prompt, field: "consolidation_prompt" },
    { key: SETTING_KEYS.consolidation_prompt_model, field: "consolidation_prompt_model" },
    { key: SETTING_KEYS.consolidation_prompt_reasoning_effort, field: "consolidation_prompt_reasoning_effort" },

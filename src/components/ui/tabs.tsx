  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-[state=active]:bg-highlight data-[state=active]:text-highlight-foreground dark:data-[state=active]:bg-highlight dark:data-[state=active]:text-highlight-foreground data-[state=active]:border-transparent dark:data-[state=active]:border-transparent",
